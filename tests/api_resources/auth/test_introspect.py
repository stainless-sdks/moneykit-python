...
class TestIntrospect:
    ...
    def test_method_retrieve(self, client: Moneykit) -> None:
        introspect = client.auth.introspect.retrieve()
        assert_matches_type(IntrospectClientResponse, introspect, path=["response"])
...
class TestAsyncIntrospect:
    ...
    async def test_method_retrieve(self, client: AsyncMoneykit) -> None:
        introspect = await client.auth.introspect.retrieve()
        assert_matches_type(IntrospectClientResponse, introspect, path=["response"])
